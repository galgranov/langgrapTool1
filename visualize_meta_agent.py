"""
Visualize the MetaAgent graph structure.
"""
from meta_agent import create_agent
...
def visualize_graph():
    ...
    try:
        ...
        # Save to file
        with open("meta_agent_graph.png", "wb") as f:
            f.write(png_data)
        
        print("✅ Graph visualization saved as 'meta_agent_graph.png'")
